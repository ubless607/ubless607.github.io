...
최근에는 여러 변형된 SSIM loss가 제안됐습니다. MS-SSIM은 SSIM에 scale space의 개념을 추가한 것입니다 [<a href='https://github.com/jorge-pessoa/pytorch-msssim'>5</a>].<br>또한 MS-SSIM과 L1-loss를 합친 mix loss로 image restoration을 진행했을 때 성능이 좋았다는 연구 결과도 있습니다 [<a href='https://ieeexplore.ieee.org/document/7797130'>6</a>]
<hr>
...
|:--:|
|Fig 1. MSE, SSIM(scikit-learn), SSIM(tensorflow), SSIM(pytorch) 결과 비교|
